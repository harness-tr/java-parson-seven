...
```
app/src/main/java/com/java-parson-seven/HelloController.java
```
...
**Important:** Replace the image placeholder `gcr.io/YOUR_PROJECT_ID/java-parson-seven:latest` with your actual GCR or Artifact Registry path.
